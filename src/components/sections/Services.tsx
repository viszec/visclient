  ...
  return (
    <ReactLenis root>
      ...
      >
        ...
        <div className="relative w-full h-[12vh] lg:h-[10vh] bg-[#efeee9] top-2/5 title-section">
          <h1
        ...
        <div className={`relative w-full ${isMobile ? 'h-[210vh]' : 'h-[55vh]'} bg-transparent cards`}>
