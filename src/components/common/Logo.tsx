...
export const Logo = () => (
  <div className="flex items-center cursor-pointer group">
    <p className="mr-2 sm:mr-0 transition-all duration-500 ease-bezier group-hover:rotate-[360deg]">
      <span className="text-base text-[#333] font-halenoir font-bold">©</span>
    </p>
    <div
    ...
    >
      ...
      >
        <Image
          ...
          className="w-3 h-3 -rotate-90"
        />
        <span className="lg:text-base 2xl:text-base text-sm ml-1 text-[#333] font-halenoir">
