...
export const Logo = () => (
  <div className="flex items-center cursor-pointer group">
    <p className="transition-all duration-500 ease-bezier group-hover:rotate-[360deg]">{'©'}</p>
    <div
      className="flex items-center relative overflow-hidden whitespace-nowrap ml-2
    ...
    >
      ...
      >
        <Image src="/icons/arrow.svg" alt="arrow" width={18} height={18} priority className="w-3 h-3 -rotate-90" />
