        ...
        >
            <div className="count-wrapper relative w-[160px] h-[340px] [clip-path:polygon(0_0,100%_0,100%_100%,0%_100%)] will-change-transform">
                <div className="count relative w-[1440px] h-[360px] flex -translate-x-[1440px] will-change-transform">
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">9</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">8</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">6</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">4</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">2</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">0</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="count-wrapper relative w-[160px] h-[340px] [clip-path:polygon(0_0,100%_0,100%_100%,0%_100%)] will-change-transform">
                <div className="count relative w-[1440px] h-[360px] flex -translate-x-[1440px] will-change-transform">
                    ...
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">5</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">8</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">7</h1>
                    </div>
                    <div className="digit relative w-[180px] h-[360px] p-4">
                        <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[320px] font-ppeditorialoldultralight font-thin leading-none text-[#e6e5df16]">6</h1>
                    </div>
            ...
            {showRevealers && (
                <>
                    <div className="revealer revealer-1 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <img src="/images/revealer-1.svg" alt="Revealer 1" className="w-full h-full object-cover" />
                    </div>

                    <div className="revealer revealer-2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <img src="/images/revealer-2.svg" alt="Revealer 2" className="w-full h-full object-cover" />
                    </div>

                    <div className="revealer revealer-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <img src="/images/revealer-3.svg" alt="Revealer 3" className="w-full h-full object-cover" />
                    </div>
                </>
            )}
        </div>
