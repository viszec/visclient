  ...
  return (
    <section className="section w-full h-full bg-black">
      <div className="flex flex-col">
        <motion.div className="flex flex-col border-t mx-20 border-gray-600 lg:flex-row justify-center lg:justify-between items-center gap-2 lg:gap-4 pt-2 lg:pt-6 sm:pt-4 pb-3 lg:pb-8">
